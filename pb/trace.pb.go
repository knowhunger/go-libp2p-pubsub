...
type TraceEvent_JmpMeta struct {
	...
	JmpMode              *string                            `protobuf:"bytes,4,opt,name=jmpMode" json:"jmpMode,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}
...
func (m *TraceEvent_JmpMeta) GetJmpMode() string {
...
func (*TraceEvent_JmpMeta_JmpMsgMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 14, 0}
}
...
func (*TraceEvent_JmpMeta_JamMaxPairMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 14, 1}
}
...
var fileDescriptor_0571941a1d628a80 = []byte{
	...
	,
}
...
func (m *TraceEvent_JmpMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.JmpMode != nil {
		...
		i = encodeVarintTrace(dAtA, i, uint64(len(*m.JmpMode)))
		i--
		dAtA[i] = 0x22
	}
	if m.Source != nil {
